                        ...
                        <div class="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
                          <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto md:mr-auto w-full md:py-8 mt-8 md:mt-0">
                            ...
                            <div class="relative mb-4">
                              <label for="purchase_day" class="leading-7 text-sm text-gray-600">入金日</label>
                              <input type="date" id="purchase_day" name="purchase_day" v-model="form.receive_date" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                              <InputError class="mt-2" :message="props.errors.receive_date" />
                            </div>
                            <div class="relative mb-4">
                              <label for="title" class="leading-7 text-sm text-gray-600">項目</label>
